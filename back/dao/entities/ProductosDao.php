...
$pROVEEDORES_TIENDA_idTIENDA=$productos->getPROVEEDORES_TIENDA_idTIENDA()->getTIENDA_idTIENDA();
      ...
      try {
          $sql= "INSERT INTO `productos`( `idPRODUCTOS`, `NOMBRE_PRODUCTO`, `UNIDAD_PRODUCTO`, `COSTO_PRODUCTO`, `PRECIOVENTA_PRODUCTO`, `VALORMINIMO_PRODUCTO`, `FECHAINGRESO_PRODUCTO`, `CATEGORIA_PRODUCTO`, `FECHAVENCIMIENTO_PRODUCTO`, `TIENDA_idTIENDA`, `CATEGORIA_idCATEGORIA`, `PROVEEDORES_idPROVEEDORES`, `PROVEEDORES_TIENDA_idTIENDA`)"
          ."VALUES ('$idPRODUCTOS','$nOMBRE_PRODUCTO','$uNIDAD_PRODUCTO','$cOSTO_PRODUCTO','$pRECIOVENTA_PRODUCTO','$vALORMINIMO_PRODUCTO','$fECHAINGRESO_PRODUCTO','$cATEGORIA_PRODUCTO','$fECHAVENCIMIENTO_PRODUCTO','$tIENDA_idTIENDA','$cATEGORIA_idCATEGORIA','$pROVEEDORES_idPROVEEDORES','$pROVEEDORES_idPROVEEDORES','$pROVEEDORES_TIENDA_idTIENDA','$pROVEEDORES_TIENDA_idTIENDA')";
